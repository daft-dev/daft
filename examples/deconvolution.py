...
# Add Plates
pgm.add_plate([1.625-.05, -1.5-.025, 1.25, 2], rect_params={'ec': 'blue'})
pgm.add_plate([1.625,     -.5,       1.25, 2], rect_params={'ec': 'orange'})
pgm.add_plate([1.625+.05,  0.5+.025, 1.25, 2], rect_params={'ec': 'red'})
...
pgm.add_text(x0-.225, -.4-.08, '= latent variable')
pgm.add_node('observed', '', x0-.5, -1.05, 1, alternate=True)
pgm.add_text(x0-.225, -1.05-.08, '= observed variable')
