...
# Latent variable.
pgm.add_node(daft.Node("w", r"$\boldsymbol{w}_{\boldsymbol{n}}$", 1, 1))

# Data.
pgm.add_node(daft.Node("x", r"$\boldsymbol{x}_{\boldsymbol{n}}$", 2, 1, observed=True))
...
# And a plate.
pgm.add_plate(daft.Plate([0.5, 0.5, 2, 1], label=r"$\boldsymbol{n} = \boldsymbol{1, \cdots, N}$",
    shift=-0.1))
